...
summary: Defines source layout, runtime configuration, security, and test conventions for multimedia.
---
...
This specification defines the local engineering rules for multimedia.
...
Small modules, explicit runtime boundaries, and colocated tests keep multimedia maintainable and safe.
