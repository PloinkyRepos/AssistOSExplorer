# multimedia Agent Guide

## Scope

multimedia owns IDE plugins and media-processing helpers for document audio, video, image, and generated preview workflows.
...
4. Read `docs/specs/DS05-ploinky-runtime-invariants.md` before touching auth, routing, guest access, MCP, HTTP services, files, logs, or runtime configuration.
...
Runs as a container-backed agent in `docker.io/assistos/ploinky-node:24-bookworm-tools` and uses `scripts/install.sh` for FFmpeg readiness.

## Key Paths

- `manifest.json`
- `docs/specs/DS05-ploinky-runtime-invariants.md`
- `IDE-plugins/`
- `skills/`
- `scripts/`
