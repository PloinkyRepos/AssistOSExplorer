...
4. Read `docs/specs/DS005-runtime-invariants.md` before touching auth, routing, guest access, MCP, HTTP services, files, logs, or runtime configuration.
...
- `manifest.json`
- `docs/specs/DS005-runtime-invariants.md`
- `IDE-plugins/`
- `skills/`
- `scripts/`
