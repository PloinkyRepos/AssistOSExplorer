...
export class ParagraphVideoPreview {
    ...
    async playPause(targetElement) {
        ...
        if (nextMode === "play") {
            ...
            targetElement.src = "./assets/icons/pause.svg";
        ...
        if (nextMode === "resume") {
            ...
            targetElement.src = "./assets/icons/play.svg";
    ...
    setupMediaPlayerEventListeners(mediaPlayer) {
        ...
        mediaPlayer.addEventListener("ended", () => {
            ...
            setTimeout(async () => {
                ...
                this.playPauseIcon.src = "./assets/icons/play.svg";
    ...
    //     audioPlayer.src = "./assets/audios/silence.mp3";
    //     audioPlayer.load();
