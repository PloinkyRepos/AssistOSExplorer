---
title: DS000-vision
summary: Defines the soplangAgent contract covered by DS000-vision.
---
...
This document defines the strategic rules for soplangBuilder as a Ploinky agent intermediary between user interface (UI) clients and SOPLang runtime services. It locks the purpose and the non-negotiable agent boundaries used by [DS02 - Architecture](specsLoader.html?spec=DS002-architecture.md), [DS03 - MCP Tool Contract and Execution Lifecycle](specsLoader.html?spec=DS003-main-behavior.md), and [DS04 - UI Bridge and IDE Plugin Integration](specsLoader.html?spec=DS004-ui-bridge.md).
