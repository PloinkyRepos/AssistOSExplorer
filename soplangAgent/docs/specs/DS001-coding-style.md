...
summary: Defines source layout, runtime configuration, security, and test conventions for soplangAgent.
---
...
This specification defines the local engineering rules for soplangAgent.
...
Small modules, explicit runtime boundaries, and colocated tests keep soplangAgent maintainable and safe.
