...
- HTTP service surface: No public HTTP service is declared; SOPLang operations are routed through MCP or local plugin integration. Manifest httpServices: none.
