---
title: DS004-ui-bridge
summary: Defines the soplangAgent contract covered by DS004-ui-bridge.
---
...
Invariant I1: UI-to-runtime communication path is MCP-based.

Invariant I2: IDE plugin channel remains optional for agent execution; MCP contracts remain primary integration boundary.

Invariant I3: integration keeps soplangBuilder as intermediary between UI intent and SOPLang runtime operations.
