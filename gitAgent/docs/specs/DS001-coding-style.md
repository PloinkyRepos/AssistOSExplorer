...
summary: Defines source layout, runtime configuration, security, and test conventions for gitAgent.
---
...
This specification defines the local engineering rules for gitAgent.
...
Small modules, explicit runtime boundaries, and colocated tests keep gitAgent maintainable and safe.
