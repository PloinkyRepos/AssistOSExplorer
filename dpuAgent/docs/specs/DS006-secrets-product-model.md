---
title: DS006-secrets-product-model
summary: Defines the dpuAgent contract covered by DS006-secrets-product-model.
---

# DS006-secrets-product-model
...
Explorer uses the model through these supported operations:
