# dpuAgent Agent Guide

## Scope

dpuAgent owns the confidential data service used by Explorer for `/Confidential`, secrets, ACL-aware records, and encrypted object storage.
...
4. Read `docs/specs/DS08-ploinky-runtime-invariants.md` before touching auth, routing, guest access, MCP, HTTP services, files, logs, or runtime configuration.
...
- `manifest.json`
- `docs/specs/DS08-ploinky-runtime-invariants.md`
- `lib/`
- `tools/`
- `tests/`
