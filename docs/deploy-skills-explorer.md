...
gh secret set SOUL_GATEWAY_PROVIDER_API_KEY --repo PloinkyRepos/AssistOSExplorer
```
...
```sh
gh variable set SOUL_GATEWAY_PROVIDER_BASE_URL --repo PloinkyRepos/AssistOSExplorer --body https://soul.axiologic.dev/v1
gh variable set SOUL_GATEWAY_PROVIDER_DISCOVERY_MODE --repo PloinkyRepos/AssistOSExplorer --body auto
gh variable set SOUL_GATEWAY_PROVIDER_ALIASES --repo PloinkyRepos/AssistOSExplorer --body fast,axl/fast,plan,code,write,deep,ultra
```
