...
summary: Defines source layout, runtime configuration, security, and test conventions for tasksAgent.
---
...
This specification defines the local engineering rules for tasksAgent.
...
Small modules, explicit runtime boundaries, and colocated tests keep tasksAgent maintainable and safe.
