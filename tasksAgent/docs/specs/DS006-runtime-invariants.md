...
summary: Defines the tasksAgent contract covered by DS006-runtime-invariants.
---
...
- HTTP route surface: No public HTTP route is declared; task operations are MCP-only.
