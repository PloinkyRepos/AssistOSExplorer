        ...
        if(this.paragraph.commands.files && this.paragraph.commands.files?.length > 0){
            ...
            for (let file of this.paragraph.commands.files) {
                filesHTML += `<div class="paragraph-file">
                                          ...
                                          <img class="download-file pointer" data-local-action="downloadFile ${file.id}" src="./assets/icons/download.svg" alt="download">
                                          <img class="delete-file pointer" data-local-action="deleteFile ${file.id}" src="./assets/icons/trash-can.svg" alt="delete">
                                        </div>`;
            }
        }
