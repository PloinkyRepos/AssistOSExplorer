export function createGitCommitService({ callTool, callAgentTool }) {
    return {
        ...
        gitConflictVersions: (payload) => callTool('git_conflict_versions', payload),
        gitCheckoutConflict: (payload) => callTool('git_checkout_conflict', payload),
        gitStash: (payload) => callTool('git_stash', payload),
        gitStashPop: (payload) => callTool('git_stash_pop', payload),
