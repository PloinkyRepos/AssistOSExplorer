        ...
        this.fileInput.addEventListener('change', (e) => {
            ...
            for (let file of this.files) {
                ...
                filesHTML += `<div class="file-item">
                                <img src="./assets/icons/file-types/${icon}" alt="icon" class="file-icon">
                                <div class="file-name">${fileName}</div>
                                <div class="file-size">${fileSize} MB</div>
                                <img src="./assets/icons/x-mark.svg" alt="Remove file" class="remove-file pointer" data-local-action="removeFile ${file.id}">
                              </div>`;
            }
