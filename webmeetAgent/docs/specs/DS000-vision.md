...
| Chat UI behavior | `IDE-plugins/webmeet-tool-button/components/webmeet-dashboard-modal/service-components/chat-component.js` |
| Guest room entry behavior | `IDE-plugins/webmeet-tool-button/components/webmeet-dashboard-modal/controllers/dashboard-session-methods.js` |
