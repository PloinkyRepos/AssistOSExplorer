...
| [DS009](specsLoader.html?spec=DS009-blackboard-agentic-diagrams.md) | Blackboard Agentic Diagrams | [[status:implemented]] | webmeet-team | Defines the revision-only Blackboard model, canonical multi-event commands, semantic focus, attached diagrams, semantic errors, and transient RoboTeam command status. |
