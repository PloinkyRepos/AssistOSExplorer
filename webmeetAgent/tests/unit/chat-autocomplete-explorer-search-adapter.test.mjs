...
import { createExplorerSearchAdapter } from '../../IDE-plugins/webmeet-tool-button/components/webmeet-dashboard-modal/services/chat-autocomplete/explorer-search-adapter.js';
