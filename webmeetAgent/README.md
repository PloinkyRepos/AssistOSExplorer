...
The main WebMeet application is the page component `webmeet-dashbaoard`, not a modal. WebMeet settings open in the dedicated WebSkel `webmeet-settings-modal`, which supports edge/corner resizing and a fullscreen toggle.
