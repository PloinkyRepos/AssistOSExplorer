...
export const scriptaExplorer = Object.freeze({
    ...
    commitMedia: (context, args) => callScriptaExplorer(context, 'webmeet_media_commit', args),
    getMedia: (context, args) => callScriptaExplorer(context, 'webmeet_media_get', args),
