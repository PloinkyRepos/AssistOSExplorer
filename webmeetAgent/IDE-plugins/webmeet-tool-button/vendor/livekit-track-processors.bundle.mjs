// livekit-client-shim.js
var getLogger = (...args) => window.LivekitClient.getLogger(...args);
...
function q(t2) {
  const e2 = z ||= new DataView(new ArrayBuffer(8));
...
var Tt = [];
function At(t2) {
  return t2 ? /^\d+$/.test(t2) ? (nt(t2), new bt(K, Y)) : null : kt ||= new bt(0, 0);
}
var bt = class {
  constructor(t2, e2) {
...
var kt;
function xt(t2) {
  return t2 ? /^-?\d+$/.test(t2) ? (nt(t2), new St(K, Y)) : null : Lt ||= new St(0, 0);
}
var St = class {
  constructor(t2, e2) {
    this.h = t2 >>> 0, this.g = e2 >>> 0;
...
function Ne(t2) {
  switch (typeof t2) {
    ...
    case "number":
      return 0 < t2 ? void 0 : 0 === t2 ? De ||= [0, void 0] : [-t2, void 0];
    case "string":
      return [0, t2];
    case "object":
      return t2;
...
function rn(t2, e2, n2 = te) {
  if (null != t2) {
    ...
    if (Array.isArray(t2)) {
      var r2 = $t(t2);
      return 2 & r2 || (e2 &&= 0 === r2 || !!(32 & r2) && !(64 & r2 || !(16 & r2)), t2 = e2 ? Jt(t2, -12293 & (34 | r2)) : tn(t2, rn, 4 & r2 ? te : n2, true, true)), t2;
    }
...
function ln(t2, e2, n2, r2) {
  ...
  if (!(n2 >= i2)) {
    var s2 = t2.length;
    return r2 && 256 & e2 && null != (r2 = t2[s2 - 1][n2]) ? (un(t2, e2, i2, n2) && null != Ht && (4 <= (e2 = (t2 = pe ??= {})[Ht] || 0) || (t2[Ht] = e2 + 1, ye())), r2) : un(t2, e2, i2, n2);
  }
...
function Mn(t2, e2, n2, r2, i2, s2) {
  var o2 = 2, a2 = !!(2 & e2);
  o2 = a2 ? 1 : o2, i2 = !!i2, s2 &&= !a2, a2 = _n(t2, e2, r2);
  var h2 = $t(a2);
  const c2 = !!(4 & h2);
  if (!c2) {
    var u2 = a2, l2 = e2;
  ...
  if (!e2) {
    ...
    e2 = i2 ? (t3, e3) => i2(t3, e3, r2) : (t3, e3) => {
      for (; mt(e3) && 4 != e3.h; ) {
        ...
        s2 && s2(e3, t3, i3) || (i3 = (s2 = e3).l, yt(s2), s2.ia ? s2 = void 0 : (o2 = s2.g.g - i3, s2.g.g = i3, s2 = pt(s2.g, o2)), i3 = t3, s2 && (de ||= /* @__PURE__ */ Symbol(), (o2 = i3[de]) ? o2.push(s2) : i3[de] = [s2]));
      }
      n2 === tr || n2 === er || n2.j || (t3[fe ||= /* @__PURE__ */ Symbol()] = n2);
    }, t2[qn] = e2;
  }
  return e2;
}
...
function sr(t2) {
  ...
  if (!(e2 = ar(t2, t2[nr] = new Qn(), ir, ir, rr)).ea && !e2.h && !e2.g) {
    ...
    n2 ? (Ne(t2[0]) === Ue ? er ? e2 = er : ((e2 = new Qn()).T = Ne(true), e2 = er = e2) : e2 = tr ||= new Qn(), e2 = t2[nr] = e2) : e2.j = true;
  }
  return e2;
}
...
function dr(t2, e2) {
  let n2, r2;
  const i2 = t2.h;
  return (t3, s2, o2) => i2(t3, s2, o2, r2 ||= fr(e2).T, n2 ||= cr(e2));
}
function fr(t2) {
  let e2 = t2[ur];
...
function mr(t2, e2, n2) {
  const r2 = t2.g;
  let i2, s2;
  return (t3, o2, a2) => r2(t3, o2, a2, s2 ||= yr(e2).T, i2 ||= Jn(e2), n2);
}
function yr(t2) {
  let e2 = t2[pr];
...
var Or = wr((function(t2, e2, n2) {
  ...
  null != (e2 = ve(e2)) && (Ot(t2, n2, 1), t2 = t2.g, (n2 = z ||= new DataView(new ArrayBuffer(8))).setFloat64(0, +e2, true), K = n2.getUint32(0, true), Y = n2.getUint32(4, true), Pt(t2, K), Pt(t2, Y));
}));
...
function Oo(t2) {
  ...
  if ((e2 = Rn(t2, Qi, 4)?.h()) && (s2.boundingBox = { originX: Nn(e2, 1) ?? 0, originY: Nn(e2, 2) ?? 0, width: Nn(e2, 3) ?? 0, height: Nn(e2, 4) ?? 0, angle: 0 }), Rn(t2, Qi, 4)?.g().length) for (const e3 of Rn(t2, Qi, 4).g()) s2.keypoints.push({ x: gn(e3, 1) ?? 0, y: gn(e3, 2) ?? 0, score: gn(e3, 4) ?? 0, label: Pe(cn(e3, 3)) ?? "" });
  return s2;
}
function Io(t2) {
  const e2 = [];
...
var sa = class {
  ...
  l(t2, e2 = true) {
    if (e2) {
      ...
      if (!(Rn(this.baseOptions, Ms, 1)?.g() || Rn(this.baseOptions, Ms, 1)?.h() || t2.baseOptions?.modelAssetBuffer || t2.baseOptions?.modelAssetPath)) throw Error("Either baseOptions.modelAssetPath or baseOptions.modelAssetBuffer must be set");
      if ((function(t3, e4) {
...
function th(t2, e2, n2, r2) {
  if (t2.V) {
    ...
    if (n2?.rotationDegrees) {
      if (0 != n2?.rotationDegrees % 90) throw Error("Expected rotation to be a multiple of 90\xB0.");
      if (Hn(s2, 5, -Math.PI * n2.rotationDegrees / 180), 0 != n2?.rotationDegrees % 180) {
        const [t3, r3] = zo(e2);
...
var Ah = class extends ih {
  ...
  o(t2) {
    if (Xn(this.h, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Hn(this.h, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Hn(this.A, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Hn(this.u, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new $s(), n2 = e2, r2 = Po(t2.cannedGesturesClassifierOptions, Rn(this.j, $s, 3)?.h());
      Cn(n2, 0, 2, r2), Cn(this.j, 0, 3, e2);
    } else void 0 === t2.cannedGesturesClassifierOptions && Rn(this.j, $s, 3)?.g();
    return t2.customGesturesClassifierOptions ? (Cn(n2 = e2 = new $s(), 0, 2, r2 = Po(t2.customGesturesClassifierOptions, Rn(this.j, $s, 4)?.h())), Cn(this.j, 0, 4, e2)) : void 0 === t2.customGesturesClassifierOptions && Rn(this.j, $s, 4)?.g(), this.l(t2);
  }
  Ka(t2, e2) {
...
var Mh = class extends ih {
  ...
  m() {
    ...
    ki(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), xi(n2, "IMAGE:input_image"), xi(n2, "NORM_RECT:norm_rect"), Si(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), Oi(t2, n2), this.g.attachProtoListener("classifications", ((t3, e3) => {
      this.j = (function(t4) {
        const e4 = { classifications: Pn(t4, ps, 1).map(((t5) => Co(Rn(t5, Xi, 4)?.g() ?? [], Bn(Nn(t5, 2), 0), jn(t5, 3)))) };
      ...
      t3 = bs(t3), this.embeddings = (function(t4) {
        return { embeddings: Pn(t4, Es, 1).map(((t5) => {
          ...
          if (void 0 !== Fn(t5, _s, xn(t5, 1))) t5 = yn(t5 = Rn(t5, _s, xn(t5, 1)), 1, ve), e4.floatEmbedding = t5.slice();
            ...
            e4.quantizedEmbedding = Rn(t5, vs, xn(t5, 2))?.qa()?.h() ?? n3;
          }
          return e4;
...
var Uh = class extends ih {
  ...
  L() {
    !(function(t2) {
      ...
      1 === e2.length && (Rn(e2[0], yi, 7)?.l()?.g() ?? /* @__PURE__ */ new Map()).forEach(((e3, n2) => {
...
var livekitLogger = getLogger2("livekit");
var livekitLoggers = Object.values(LoggerNames).map((name) => getLogger2(name));
livekitLogger.setDefaultLevel(
  2
  /* info */
);
...
function setLogLevel(level, loggerName) {
  if (loggerName) {
    getLogger2(loggerName).setLevel(level);
  } else {
...
function setLogExtension(extension, logger) {
  ...
  loggers.forEach((logR) => {
    ...
    logR.methodFactory = (methodName, configLevel, loggerName) => {
      ...
      const needLog = logLevel >= configLevel && logLevel < 5;
      return (msg, context) => {
        if (context)
...
var ProcessorWrapper = class _ProcessorWrapper {
  constructor(transformer, name, options = {}) {
    ...
    this.maxFps = (_a2 = options.maxFps) != null ? _a2 : 30;
  }
  /**
  ...
  initStreamProcessorPath() {
    ...
    pipedStream.pipeTo(this.trackGenerator.writable).then(() => this.handleMediaExhausted()).catch((e2) => {
      if (e2 instanceof DOMException && e2.name === "AbortError") {
        this.log.log("stream processor path aborted");
      } else if (e2 instanceof DOMException && e2.name === "InvalidStateError" && e2.message === "Stream closed") {
        this.log.log("stream processor underlying stream closed");
        this.handleMediaExhausted();
      } else {
        this.log.error("error when trying to pipe", e2);
        this.destroy();
      }
    });
  ...
  initFallbackPath() {
    ...
    this.frameCallback = (frame) => {
      ...
      try {
        ...
        this.log.error("Error in transform:", e2);
        frame.close();
      }
    };
    ...
    const renderLoop = () => {
      ...
      if (hasNewFrame && timeThresholdMet) {
        ...
        try {
          ...
          this.log.error("Error in render loop:", e2);
        }
      }
      this.animationFrameId = requestAnimationFrame(renderLoop);
    };
  ...
  async cleanup() {
    ...
    if (this.useStreamFallback) {
      ...
      (_a2 = this.capturedStream) == null ? void 0 : _a2.getTracks().forEach((track) => track.stop());
    } else {
...
var log = getLogger2(
  "livekit-track-processor-web-gl"
  /* WebGl */
);
...
function createProgram(gl, vs2, fs2) {
...
var VideoTransformer = class {
  ...
  async restart({ outputCanvas, inputElement: inputVideo }) {
    var _a2;
    this.canvas = outputCanvas || null;
    (_a2 = this.gl) == null ? void 0 : _a2.cleanup();
    this.gl = setupWebGL(
      this.canvas || createCanvas(inputVideo.videoWidth, inputVideo.videoHeight)
    );
    this.inputVideo = inputVideo;
...
var BackgroundProcessor = class extends VideoTransformer {
  ...
  async init({ outputCanvas, inputElement: inputVideo }) {
    ...
    const fileSet = await Xo.forVisionTasks(
    ...
    this.imageSegmenter = await Uh.createFromOptions(fileSet, {
      baseOptions: {
    ...
    if ((_e2 = this.options) == null ? void 0 : _e2.imagePath) {
    ...
    (_h2 = this.gl) == null ? void 0 : _h2.setBackgroundDisabled((_g = this.options.backgroundDisabled) != null ? _g : false);
  }
  async destroy(options) {
    var _a2;
    await super.destroy();
    await ((_a2 = this.imageSegmenter) == null ? void 0 : _a2.close());
    this.backgroundImageAndPath = null;
  ...
  async loadAndSetBackground(path) {
    var _a2, _b;
    if (!this.backgroundImageAndPath || ((_a2 = this.backgroundImageAndPath) == null ? void 0 : _a2.path) !== path) {
      const img = new Image();
  ...
  async transform(frame, controller) {
    ...
    try {
      ...
      let skipProcessingFrame = (_b = (_a2 = this.isDisabled) != null ? _a2 : this.options.backgroundDisabled) != null ? _b : false;
      ...
      if (this.isFirstFrame) {
        ...
        if (this.inputVideo) {
          await new Promise((resolve) => {
            this.inputVideo.requestVideoFrameCallback((_now, e2) => {
              const durationUntilFrameRenderedInMs = e2.expectedDisplayTime - e2.presentationTime;
      ...
      const segmentationPromise = new Promise((resolve, reject) => {
        ...
        try {
          ...
          (_a22 = this.imageSegmenter) == null ? void 0 : _a22.segmentForVideo(frame, segmentationStartTimeMs, (result) => {
      ...
      this.log.error("Error while processing frame: ", e2);
    } finally {
      if (!enqueuedFrame) {
        frame.close();
      }
  ...
  async update(opts) {
    ...
    (_b = this.gl) == null ? void 0 : _b.setBlurRadius((_a2 = opts.blurRadius) != null ? _a2 : null);
    if (opts.imagePath) {
      await this.loadAndSetBackground(opts.imagePath);
    } else {
      (_c = this.gl) == null ? void 0 : _c.setBackgroundImage(null);
    }
    (_e2 = this.gl) == null ? void 0 : _e2.setBackgroundDisabled((_d = opts.backgroundDisabled) != null ? _d : false);
  }
  async drawFrame(frame) {
    var _a2;
    if (!this.gl)
      return;
    (_a2 = this.gl) == null ? void 0 : _a2.renderFrame(frame);
  }
  async updateMask(mask) {
    var _a2;
    if (!mask)
      return;
    (_a2 = this.gl) == null ? void 0 : _a2.updateMask(mask.getAsWebGLTexture());
  }
};
    ...
    switch (options.mode) {
      case "background-blur":
        await this.updateTransformerOptions({
          imagePath: void 0,
          blurRadius: (_a2 = options.blurRadius) != null ? _a2 : DEFAULT_BLUR_RADIUS,
